...
public class CreateAdvertTypeActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_advert_type);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        ImageView offer = (ImageView) findViewById(R.id.offerImage);
        offer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Globals.newAdvert.setAdvert_type("Offer");
                Intent intent = new Intent(CreateAdvertTypeActivity.this, CreateAdvertItemType.class);
                startActivity(intent);
            }
        });

        ImageView request = (ImageView) findViewById(R.id.requestImage);
        request.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Globals.newAdvert.setAdvert_type("Request");
                Intent intent = new Intent(CreateAdvertTypeActivity.this, CreateAdvertItemType.class);
                startActivity(intent);
            }
        });
