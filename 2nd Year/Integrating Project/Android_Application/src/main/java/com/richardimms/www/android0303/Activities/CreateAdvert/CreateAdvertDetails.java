...
public class CreateAdvertDetails extends ActionBarActivity {
    Advert newAd = Globals.selectedAdvert;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_advert_details);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        /* Search icon for the action bar ***************************************************/
        SearchManager searchManager = (SearchManager) getSystemService(Context.SEARCH_SERVICE);
        SearchView searchView = (SearchView) menu.findItem(R.id.search).getActionView();
        ComponentName cn = new ComponentName(this, SearchAdvertsActivity.class);
        searchView.setSearchableInfo(searchManager.getSearchableInfo(cn));
        /************************************************************************************/
        final EditText advertTitle = (EditText) findViewById(R.id.advertTitle);
        final EditText advertDescription = (EditText) findViewById(R.id.createAdvertDescription);
        Button confirm = (Button) findViewById(R.id.btnConfirmDetails);

        confirm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(advertTitle.getText().length() > 3 || advertDescription.getText().length() > 10) {
                    ...
                    Intent intent = new Intent(CreateAdvertDetails.this, CreateAdvertDetails2.class);
                    startActivity(intent);
                }
                else
                {
                    Toast.makeText(CreateAdvertDetails.this, "Please enter an Advert/Description", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    /*This helps navigate the side navigation bar based on the position of the list */
