<%-- 
    ...
    Author     : DominicY
--%>
<!--A page to display help to guests. Different navbars are added-->
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="main"><br>
                            ...
                            <div class="row"><!--Help list - all hard coded-->
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <input class="form-control" type="text" 
                                       name="subject" id="subject" placeholder="Enter Subject Here..." required/><br>
                                <textarea class="form-control" id="body" name="body"
                                          rows="4" cols="20" placeholder="Enter Email here..." required></textarea><br>
                                <input class="form-control" type="text" 
                                       name="email" placeholder="Enter your email here..." required/>
                            </div>
                            <div class="modal-footer">
                                <input type="hidden" name="whichContact" value="guest" />
